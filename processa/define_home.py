...
estrutura_json = "/home/rooke/Projetos/mob_social/data/geo_time_location_in_geojson_min_11_filtered.teste.json"
...
for user in data:
    ...
    # se na ordenacao a primeira tiver a mesma quantidade que a segunda, verifico qual tem mais localizacoes noturnas
